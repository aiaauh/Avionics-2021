...
//Modified by Raj and Jo 06/02/2022
//Boards:
//   Teensy 4.1
...
void setup() {  // This is the setup block of our code.
  ...
  header += "[X(m/s^2)]\t[Y(m/s^2)]\t[Z(m/s^2)]\t[Temperature(C)]\t[Temperature (F)]\t[X Accel(m/s^2)]\t[Y Accel Gyro(m/s^2)]\t[Z Accel(m/s^2)]\t[X Gyro(m/s^2)]\t[Y Gyro(m/s^2)]\t[Z Gyro(m/s^2)]\t";
